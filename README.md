...
- **Messaging** — Send text, message cards, media, delete messages, answer callback queries
...
- Club: `get-my-clubs`, `create-club`, `update-club`, `create-club-invite`, `apply-club`, `approve-club-apply`, `leave-club`, `quit-club`, `mute-club-member`, `kick-club-member`
...
- Club membership/moderation actions (`leave-club`, `quit-club`, `mute-club-member`, `kick-club-member`) use `club_id`, not `chat_id`.
...
// Member bot: leave the club as itself
{ "action": "leave-club", "club_id": 123456 }
