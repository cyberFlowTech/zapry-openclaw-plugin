    ...
    api.registerTool((toolCtx: any) => {
      ...
      return {
        ...
        description:
          ...
          "sending text, link cards (send-link-card), and media (send-photo, send-video, send-audio, send-document, send-voice, send-animation) to any chat including groups. " +
        ...
        parameters: {
          ...
          properties: {
            ...
            content: {
              type: "string" as const,
              description: "Text content (for comment-post or send-link-card summary)",
            },
            title: {
              type: "string" as const,
